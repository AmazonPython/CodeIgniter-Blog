            ...
            <div class="w960 mt_10">
                <div class="w650">
                    <ul class="tips" id="wf-main" style="display:none" >
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/6.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/1.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/2.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/3.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/4.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/5.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/6.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/5.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/4.jpg" width="197" height="273"alt="" /></li>
                        <li class="wf-cld"><img rel="lazy" lazy_src="<?php echo base_url(); ?>static/images/photo/3.jpg" width="197" height="273"alt="" /></li>
